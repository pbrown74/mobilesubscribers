...
public class MobileSubscriberController {
	...
	public List<MobileSubscriber> findMobileSubscribersByServiceType(@PathVariable(value = "serviceType") String serviceType) {
	...
	public List<MobileSubscriber> findMobileSubscribersByServiceStartDate(@PathVariable(value = "serviceStartDate") Long serviceStartDate) {
	...
	public List<MobileSubscriber> findMobileSubscribersByCustomerIdUser(@PathVariable(value = "customerIdUser") Long customerIdUser) {
	...
	public Optional<MobileSubscriber> findMobileSubscribersByMobileNumber(@PathVariable(value = "msisdn") String msisdn) {
	...
	public MobileSubscriber changeMobileSubscriberPaymentPlanToPrepaid(@PathVariable(value = "msisdn") String msisdn) {
		return mobSubsService.changeMobileSubscriberPaymentPlanFromTo(msisdn, PaymentType.POSTPAID, PaymentType.PREPAID);
	}
	...
	public MobileSubscriber changeMobileSubscriberPaymentPlanToPostpaid(@PathVariable(value = "msisdn") String msisdn) {
		return mobSubsService.changeMobileSubscriberPaymentPlanFromTo(msisdn, PaymentType.PREPAID, PaymentType.POSTPAID);
	}
	...
	public Optional<MobileSubscriber> deleteMobileSubscribersByMobileNumber(@PathVariable(value = "msisdn") String msisdn) {
	...
	public MobileSubscriber assignMobileSubscriberUserAndOwner(@PathVariable(value = "subsId") Long id, @RequestBody MobileSubscriber mobSubs) {
