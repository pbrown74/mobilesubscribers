...
class CustomerApplicationTests {
    ...
    private MobileSubscriber buildSubscriber(int id, long version, String msisdn, Long customerIdOwner,
            Long customerIdUser, String serviceType, Long serviceStartDate) {
